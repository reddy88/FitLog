...
class StartedWorkoutSetDetailTableViewCell: UITableViewCell {
    ...
    func updateViews() {
        ...
        weightTextField.placeholder = "\(exerciseSet.weight ?? 0)"
        weightTextField.text = "\(exerciseSet.weight ?? 0)"
        repsTextField.placeholder = "\(exerciseSet.reps ?? 0)"
        repsTextField.text = "\(exerciseSet.reps ?? 0)"
